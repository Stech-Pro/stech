...
function getPhysical(position) {
  switch (position) {
    case 'QB':
      return { height: '180-185cm', weight: '75-80kg' };
    case 'RB':
      return { height: '170-178cm', weight: '70-78kg' };
    case 'WR':
      return { height: '175-185cm', weight: '70-78kg' };
    case 'TE':
      return { height: '185-195cm', weight: '85-95kg' };
    case 'OL':
      return { height: '185-195cm', weight: '100-120kg' };
    case 'DL':
      return { height: '185-195cm', weight: '95-115kg' };
    case 'LB':
      return { height: '180-190cm', weight: '80-90kg' };
    case 'DB':
      return { height: '170-180cm', weight: '70-80kg' };
    case 'K':
    case 'P':
      return { height: '175-180cm', weight: '70-75kg' };
    default:
      return { height: '175-185cm', weight: '75-85kg' };
  }
}
...
fs.writeFileSync(
  'all-teams-players-complete.json',
