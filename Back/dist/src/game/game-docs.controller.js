...
exports.GameDocsController = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const game_sample_dto_1 = require("./dto/game-sample.dto");
const game_upload_dto_1 = require("./dto/game-upload.dto");
let GameDocsController = class GameDocsController {
...
exports.GameDocsController = GameDocsController;
__decorate([
    (0, common_1.Get)('sample-json'),
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: game_sample_dto_1.SampleGameDataDto,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", game_sample_dto_1.SampleGameDataDto)
], GameDocsController.prototype, "getSampleJsonStructure", null);
__decorate([
    (0, common_1.Get)('sample-response'),
    (0, swagger_1.ApiOperation)({
        summary: '📊 성공 응답 예시',
        description: `
    ## ✅ 성공적인 업로드 후 응답 형식
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: game_sample_dto_1.SampleSuccessResponseDto,
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", game_sample_dto_1.SampleSuccessResponseDto)
], GameDocsController.prototype, "getSampleResponse", null);
__decorate([
...
], GameDocsController.prototype, "getErrorCodes", null);
exports.GameDocsController = GameDocsController = __decorate([
    (0, swagger_1.ApiTags)('🏈 Game Data Upload'),
    (0, swagger_1.ApiExtraModels)(game_sample_dto_1.SampleGameDataDto, game_sample_dto_1.SampleSuccessResponseDto, game_upload_dto_1.GameUploadSuccessDto, game_upload_dto_1.GameUploadErrorDto),
    (0, common_1.Controller)('api/game/docs')
], GameDocsController);
//# sourceMappingURL=game-docs.controller.js.map